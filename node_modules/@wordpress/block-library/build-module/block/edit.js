...
import { __experimentalUseInnerBlocksProps as useInnerBlocksProps, InnerBlocks, BlockControls, InspectorControls, useBlockProps, Warning } from '@wordpress/block-editor';
...
export default function ReusableBlockEdit(_ref) {
  ...
  }, __('Convert to regular blocks')))), createElement(InspectorControls, null, createElement(PanelBody, null, createElement(TextControl, {
    label: __('Name'),
    value: title,
    onChange: setTitle
  }))), createElement("div", {
