...
import { Icon, Image, ImageEditingButton, IMAGE_DEFAULT_FOCAL_POINT, PanelBody, RangeControl, UnitControl, BottomSheet, ToolbarButton, ToolbarGroup, Gradient, ColorPalette, ColorPicker, BottomSheetConsumer, useConvertUnitToMobile } from '@wordpress/components';
...
import { attributesFromMedia, COVER_MIN_HEIGHT, IMAGE_BACKGROUND_TYPE, VIDEO_BACKGROUND_TYPE, CSS_UNITS } from './shared';
...
var Cover = function Cover(_ref) {
  ...
  var convertedMinHeight = useConvertUnitToMobile(minHeight || COVER_DEFAULT_HEIGHT, minHeightUnit);
