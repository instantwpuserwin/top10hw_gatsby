...
import { ToolbarButton, ToolbarGroup, PanelBody, ToggleControl, BottomSheet, SelectControl, Icon } from '@wordpress/components';
...
export var FileEdit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FileEdit, [{
    ...
    value: function getInspectorControls(_ref, media, isUploadInProgress, isUploadFailed) {
      ...
      var dimmedStyle = isCopyUrlDisabled && styles.disabledButton;
      var finalButtonStyle = Object.assign({}, actionButtonStyle, dimmedStyle);
    ...
    value: function getFileComponent(openMediaOptions, getMediaOptions) {
      ...
      return createElement(MediaUploadProgress, {
        ...
        renderContent: function renderContent(_ref4) {
          ...
          }, _this4.getPlaceholderWidth(placeholderText), isUploadInProgress || _this4.getToolbarEditButton(openMediaOptions), getMediaOptions(), _this4.getInspectorControls(attributes, media, isUploadInProgress, isUploadFailed), createElement(View, {
