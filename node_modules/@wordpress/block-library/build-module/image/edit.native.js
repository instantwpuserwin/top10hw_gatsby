...
import { CycleSelectControl, Icon, PanelBody, TextControl, ToolbarButton, ToolbarGroup, Image, WIDE_ALIGNMENTS, LinkSettingsNavigation } from '@wordpress/components';
...
import { image as placeholderIcon, textColor, replace, expand } from '@wordpress/icons';
/**
...
export var ImageEdit = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ImageEdit, [{
    ...
    key: "getLinkSettings",
    value: function getLinkSettings() {
      var isLinkSheetVisible = this.state.isLinkSheetVisible;

      var _this$props4 = this.props,
          _this$props4$attribut = _this$props4.attributes,
          url = _this$props4$attribut.href,
          unMappedAttributes = _objectWithoutProperties(_this$props4$attribut, ["href"]),
          setAttributes = _this$props4.setAttributes;

      var mappedAttributes = _objectSpread(_objectSpread({}, unMappedAttributes), {}, {
        url: url
      });

      var setMappedAttributes = function setMappedAttributes(_ref2) {
        var href = _ref2.url,
            restAttributes = _objectWithoutProperties(_ref2, ["url"]);

        return href === undefined ? setAttributes(restAttributes) : setAttributes(_objectSpread(_objectSpread({}, restAttributes), {}, {
          href: href
        }));
      };
    ...
    value: function render() {
      ...
      var _this$props5 = this.props,
          ...
          imageSizes = _this$props5.imageSizes,
      ...
      var sizeOptions = map(imageSizes, function (_ref3) {
        var name = _ref3.name,
            slug = _ref3.slug;
        return {
          value: slug,
      ...
      var getInspectorControls = function getInspectorControls() {
        return createElement(InspectorControls, null, createElement(PanelBody, {
          ...
          clientId: clientId,
          url: url
        })), createElement(PanelBody, null, image && sizeOptionsValid && createElement(CycleSelectControl, {
          icon: expand,
          label: __('Size'),
