...
export default function Image(_ref) {
  ...
  var _useSelect2 = useSelect(function (select) {
    ...
    return pick(getSettings(), ['imageEditing', 'imageSizes', 'maxWidth', 'mediaUpload']);
  }),
  ...
  var controls = createElement(Fragment, null, createElement(BlockControls, null, !multiImageSelection && !isEditingImage && createElement(ToolbarGroup, null, createElement(ImageURLInputUI, {
    url: href || '',
    ...
    linkClass: linkClass,
    rel: rel
  })), allowCrop && createElement(ToolbarGroup, null, createElement(ToolbarButton, {
  ...
  })), !multiImageSelection && !isEditingImage && createElement(MediaReplaceFlow, {
    mediaId: id,
    mediaURL: url,
    allowedTypes: ALLOWED_MEDIA_TYPES,
    accept: "image/*",
  ...
  }, controls, img, (!RichText.isEmpty(caption) || isSelected) && createElement(RichText, {
    ref: captionRef,
    tagName: "figcaption",
