...
import { AlignmentToolbar, BlockControls, InspectorControls, useBlockProps, PlainText } from '@wordpress/block-editor';
...
export default function PostTitleEdit(_ref) {
  ...
  var title = post.title,
      link = post.link;
  var titleElement = createElement(PlainText, _extends({
    tagName: TagName,
  ...
  if (isLink) {
    titleElement = createElement("a", _extends({
      href: link,
      target: linkTarget,
      rel: rel,
