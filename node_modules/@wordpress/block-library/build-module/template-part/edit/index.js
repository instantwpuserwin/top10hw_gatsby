...
import { BlockControls, InspectorAdvancedControls, useBlockProps } from '@wordpress/block-editor';
...
export default function TemplatePartEdit(_ref) {
  ...
  var templatePartId = theme + '//' + slug; // Set the postId block attribute if it did not exist,
  ...
  var _useSelect = useSelect(function (select) {
    ...
    var entityRecord = theme && slug ? select('core').getEntityRecord('postType', 'wp_template_part', theme + '//' + slug) : null;
    return {
  ...
  }), !isPlaceholder && isResolved && createElement(BlockControls, null, createElement(ToolbarGroup, {
  ...
  }))), !isPlaceholder && isResolved && createElement(TemplatePartInnerBlocks, {
    postId: templatePartId,
