...
function TemplatePartItem(_ref) {
  ...
  var onClick = useCallback(function () {
    ...
    __('Template Part "%s" inserted.'), title), {
      type: 'snackbar'
    });
    onClose();
  }, [slug, theme]);
