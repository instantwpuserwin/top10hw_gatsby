...
function ColumnEdit(_ref) {
  ...
  var _ref2 = (0, _components.getValueAndUnit)(width) || {},
  ...
  var _useState = (0, _element.useState)(valueUnit || '%'),
  ...
  var onChangeWidth = function onChangeWidth(nextWidth) {
    var widthWithUnit = (0, _utils.getWidthWithUnit)(nextWidth, widthUnit);
    setAttributes({
      width: widthWithUnit
    });
  };
  ...
  var onChangeUnit = function onChangeUnit(nextUnit) {
    ...
    var widthWithoutUnit = parseFloat(width || (0, _utils.getWidths)(columns)[selectedColumnIndex]);
    setAttributes({
  ...
  var renderAppender = (0, _element.useCallback)(function () {
    ...
    if (isSelected) {
      return (0, _element.createElement)(_reactNative.View, {
        style: (isWider(screenWidth, 'mobile') || isScreenWidthEqual) && (hasChildren ? _editor.default.columnAppender : _editor.default.wideColumnAppender)
