...
function CoverEdit(_ref3) {
  ...
  var style = _objectSpread(_objectSpread({}, isImageBackground && hasParallax ? (0, _shared.backgroundImageStyles)(url) : {}), {}, {
  ...
  var mediaStyle = {
    ...
    focalPoint && !hasParallax ? "".concat(Math.round(focalPoint.x * 100), "% ").concat(Math.round(focalPoint.y * 100), "%") : undefined
  };
  ...
  var controls = (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.BlockControls, null, (0, _element.createElement)(_blockEditor.__experimentalBlockFullHeightAligmentToolbar, {
    isActive: isMinFullHeight,
    onToggle: toggleMinFullHeight
  }), hasBackground && (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.__experimentalBlockAlignmentMatrixToolbar, {
  ...
  }), isImageBackground && !hasParallax && (0, _element.createElement)("img", {
    ref: isDarkElement,
