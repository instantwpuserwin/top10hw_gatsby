...
function save(_ref) {
  ...
  return (0, _element.createElement)("div", _blockEditor.useBlockProps.save({
  ...
  }), isImageBackground && url && !hasParallax && (0, _element.createElement)("img", {
    className: (0, _classnames2.default)('wp-block-cover__image-background', id ? "wp-image-".concat(id) : null),
    alt: "",
    src: url,
    style: {
    ...
    className: (0, _classnames2.default)('wp-block-cover__video-background', 'intrinsic-ignore'),
    autoPlay: true,
    muted: true,
    loop: true,
    playsInline: true,
