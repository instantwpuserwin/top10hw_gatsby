...
var FileEdit = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(FileEdit, [{
    ...
    value: function getInspectorControls(_ref, media, isUploadInProgress, isUploadFailed) {
      ...
      var dimmedStyle = isCopyUrlDisabled && _style.default.disabledButton;
    ...
    value: function getFileComponent(openMediaOptions, getMediaOptions) {
      ...
      return (0, _element.createElement)(_blockEditor.MediaUploadProgress, {
        ...
        renderContent: function renderContent(_ref4) {
          ...
          }, _this4.getPlaceholderWidth(placeholderText), isUploadInProgress || _this4.getToolbarEditButton(openMediaOptions), getMediaOptions(), _this4.getInspectorControls(attributes, media, isUploadInProgress, isUploadFailed), (0, _element.createElement)(_reactNative.View, {
