...
function Image(_ref) {
  ...
  var _useSelect = (0, _data.useSelect)(function (select) {
    ...
    var multiSelectedClientIds = getMultiSelectedBlockClientIds();
    return {
      image: id && isSelected ? getMedia(id) : null,
      multiImageSelection: multiSelectedClientIds.length && multiSelectedClientIds.every(function (clientId) {
        return getBlockName(clientId) === 'core/image';
      })
    };
  }, [id, isSelected]),
      image = _useSelect.image,
      multiImageSelection = _useSelect.multiImageSelection;

  var _useSelect2 = (0, _data.useSelect)(function (select) {
    var _select3 = select('core/block-editor'),
        getSettings = _select3.getSettings;

    return (0, _lodash.pick)(getSettings(), ['imageEditing', 'imageSizes', 'maxWidth', 'mediaUpload']);
  }),
      imageEditing = _useSelect2.imageEditing,
      imageSizes = _useSelect2.imageSizes,
      maxWidth = _useSelect2.maxWidth,
      mediaUpload = _useSelect2.mediaUpload;
  ...
  var allowCrop = !multiImageSelection && canEditImage && !isEditingImage;
  var controls = (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.BlockControls, null, !multiImageSelection && !isEditingImage && (0, _element.createElement)(_components.ToolbarGroup, null, (0, _element.createElement)(_blockEditor.__experimentalImageURLInputUI, {
    url: href || '',
    ...
    linkClass: linkClass,
    rel: rel
  })), allowCrop && (0, _element.createElement)(_components.ToolbarGroup, null, (0, _element.createElement)(_components.ToolbarButton, {
  ...
  })), !multiImageSelection && !isEditingImage && (0, _element.createElement)(_blockEditor.MediaReplaceFlow, {
    mediaId: id,
    mediaURL: url,
    allowedTypes: _constants.ALLOWED_MEDIA_TYPES,
    accept: "image/*",
  ...
  return (0, _element.createElement)(_imageEditing.ImageEditingProvider, {
    ...
    naturalHeight: naturalHeight,
    clientWidth: clientWidth,
    onSaveImage: function onSaveImage(imageAttributes) {
      return setAttributes(imageAttributes);
    },
    isEditing: isEditingImage,
    onFinishEditing: function onFinishEditing() {
      return setIsEditingImage(false);
    }
  }, controls, img, (!_blockEditor.RichText.isEmpty(caption) || isSelected) && (0, _element.createElement)(_blockEditor.RichText, {
    ref: captionRef,
    tagName: "figcaption",
