...
function TemplatePartItem(_ref) {
  ...
  var slug = templatePart.slug,
      ...
      title = templatePart.title; // The 'raw' property is not defined for a brief period in the save cycle.
  ...
  var onClick = (0, _element.useCallback)(function () {
    ...
    (0, _i18n.__)('Template Part "%s" inserted.'), title), {
      type: 'snackbar'
    });
    onClose();
  }, [slug, theme]);
...
function TemplatePartsByTheme(_ref3) {
  ...
  var templatePartsByTheme = (0, _element.useMemo)(function () {
    return Object.values((0, _lodash.groupBy)(templateParts, 'theme'));
  }, [templateParts]);
...
function TemplatePartSearchResults(_ref4) {
  ...
  var filteredTPs = (0, _element.useMemo)(function () {
    ...
    searchResults.sort(function (a, b) {
      ...
      return (0, _lodash.deburr)(a.theme).toLowerCase().indexOf(normalizedFilterValue) - (0, _lodash.deburr)(b.theme).toLowerCase().indexOf(normalizedFilterValue);
    });
  ...
  return filteredTPs.map(function (templatePart) {
    return (0, _element.createElement)(PanelGroup, {
      key: templatePart.id,
      title: templatePart.theme || (0, _i18n.__)('Custom')
